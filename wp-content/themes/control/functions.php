...
function control_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'control' ),
	) );
 ...
 */
function control_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'control_content_width', 640 );
}
add_action( 'after_setup_theme', 'control_content_width', 0 );
...
function control_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'control' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'control' ),
...
function control_scripts() {
	wp_enqueue_style( 'control-style', get_stylesheet_uri() );

	wp_enqueue_script( 'control-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'control-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
 ...
 * adding post-types
 */
require get_template_directory() . '/inc/directors.php';
 ...
 * Adding extra-fields
 */
require get_template_directory() . '/inc/my-extra-fields.php';
